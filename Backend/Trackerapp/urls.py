...
# authentication url paths
    ...
    url(r'api/projects/(?P<pk>[0-9]+)/update/members/$', UpdateProjectMembersView.as_view(), name='api_project_members_update'),    # Update Project Members
    ...
    url(r'api/students/(?P<pk>[0-9]+)/projects/$', StudentProjectsView.as_view(), name='api_student_projects'),    # Update Student profile
